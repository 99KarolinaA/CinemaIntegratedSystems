...
namespace Cinema.Service.Implementation
{
    public class TicketService : ITicketService
    {
        ...
        public List<Ticket> TicketsForMovie(Guid movieId)
        {
            return this._ticketRepository.TicketsForMovie(movieId).ToList();
        }
        public List<Ticket> FilterTickets(DateTime date)
        {
            return this._ticketRepository.FilterTickets(date).ToList();
        }
